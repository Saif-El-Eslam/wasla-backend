...
import { extractionMaintenanceRouter } from './modules/extraction/extraction-maintenance.routes';
import { feedbackRouter, publicFeedbackRouter } from './modules/feedback/feedback.routes';
...
apiRouter.use('/public/feedback', publicFeedbackRouter);
apiRouter.use('/auth', authRouter);
apiRouter.use('/admin/auth', adminAuthRouter);
apiRouter.use('/uploads', imageUploadRouter);
apiRouter.use('/internal', extractionMaintenanceRouter);
