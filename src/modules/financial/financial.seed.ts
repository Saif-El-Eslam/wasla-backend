...
export const defaultTransactionCategories = [
  ...
  {
    systemKey: 'income_other_income',
    type: 'IN',
    name: { en: 'Other Income', ar: 'إيرادات أخرى' },
    sortOrder: 30,
  },
  {
    systemKey: 'expense_ingredients',
    type: 'OUT',
    name: { en: 'Ingredients', ar: 'المكونات' },
    sortOrder: 10,
  },
  {
    systemKey: 'expense_salaries',
    type: 'OUT',
  ...
  {
    systemKey: 'expense_marketing',
    type: 'OUT',
    name: { en: 'Marketing', ar: 'التسويق' },
    sortOrder: 60,
  },
  {
    systemKey: 'expense_delivery_fees',
    type: 'OUT',
    name: { en: 'Delivery Fees', ar: 'رسوم التوصيل' },
    sortOrder: 70,
  },
  {
    systemKey: 'expense_packaging',
    type: 'OUT',
    name: { en: 'Packaging', ar: 'التغليف' },
    sortOrder: 80,
  },
  {
    systemKey: 'expense_other_expense',
    type: 'OUT',
    name: { en: 'Other Expense', ar: 'مصروفات أخرى' },
    sortOrder: 90,
  },
] as const;
...
export const defaultPaymentMethods = [
  ...
  {
    systemKey: 'instapay',
    name: { en: 'InstaPay', ar: 'إنستاباي' },
    kind: 'WALLET',
    sortOrder: 30,
  },
  {
    systemKey: 'vodafone_cash',
    name: { en: 'Vodafone Cash', ar: 'فودافون كاش' },
    kind: 'WALLET',
    sortOrder: 40,
  },
  {
    systemKey: 'delivery_app',
    name: { en: 'Delivery App', ar: 'تطبيق توصيل' },
    kind: 'DELIVERY_APP',
    sortOrder: 50,
  },
  {
